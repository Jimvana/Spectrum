# Spectrum Algo — Dictionary v13 Snapshot

**Date captured:** 2026-05-13  
**Dict version:** 13  
**SPEC_TOKEN_COUNT:** 235,112  
**Languages covered:** Python, HTML, JS, CSS, Text, TypeScript, SQL, Rust, PHP, XML-compatible, Java, C, C++, Go, C#, Shell, JSON, YAML, TOML, PowerShell  

## Contents

This directory is a read-only snapshot of the core encoding logic as it existed at dictionary version 13.  It is provided for reference, auditing, and comparison across versions.
...
- `spec_format\_frozen\v10.py`
- `spec_format\_frozen\v11.py`
- `spec_format\_frozen\v12.py`
...
- `tokenizers\c_tokenizer.py`
- `tokenizers\code_tokenizer.py`
- `tokenizers\config_tokenizer.py`
- `tokenizers\cpp_tokenizer.py`
- `tokenizers\csharp_tokenizer.py`
- `tokenizers\css_tokenizer.py`
- `tokenizers\go_tokenizer.py`
- `tokenizers\html_tokenizer.py`
- `tokenizers\java_tokenizer.py`
- `tokenizers\js_tokenizer.py`
- `tokenizers\php_tokenizer.py`
- `tokenizers\powershell_tokenizer.py`
- `tokenizers\rust_tokenizer.py`
- `tokenizers\shell_tokenizer.py`
- `tokenizers\sql_tokenizer.py`
- `tokenizers\text_tokenizer.py`
- `tokenizers\ts_tokenizer.py`
- `tokenizers\xml_tokenizer.py`
