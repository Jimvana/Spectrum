# Spectrum Algo — Dictionary v12 Snapshot

**Date captured:** 2026-05-03
**Dict version:** 12
**SPEC_TOKEN_COUNT:** 235,021
**Languages covered:** Python, HTML, JS, CSS, Text, TypeScript, SQL, Rust, PHP, XML/Wiki, Java, C, C++, Go, C#, Shell, JSON, YAML, TOML

## Contents

This directory is a read-only snapshot of the core encoding logic as it existed at dictionary version 12.  It is provided for reference, auditing, and comparison across versions.
