# Spectrum Algo — Dictionary v11 Snapshot

**Date captured:** 2026-05-03
**Dict version:** 11
**SPEC_TOKEN_COUNT:** 234,957
**Languages covered:** Python, HTML, JS, CSS, Text, TypeScript, SQL, Rust, PHP, XML/Wiki, Java

## Contents

This directory is a read-only snapshot of the core encoding logic as it existed at dictionary version 11.  It is provided for reference, auditing, and comparison across versions.
