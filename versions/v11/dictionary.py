...
# ---------------------------------------------------------------------------
# XML / Wikimedia tokens  ->  RGB
# v10 additions. These are direct core-dictionary tokens for lossless XML and
# MediaWiki source streams. Existing tokens such as "==", "===", and "'''"
# are intentionally not repeated here to preserve append-only ID stability.
# ---------------------------------------------------------------------------
XML_TOKENS = {
    "<mediawiki":             (246,   0, 130),
    "</mediawiki>":           (246,   1, 130),
    ...
    "<parentid>":             (246,  15, 130),
    "</parentid>":            (246,  16, 130),
    "<timestamp>":            (246,  17, 130),
    "</timestamp>":           (246,  18, 130),
    "<contributor>":          (246,  19, 130),
    "</contributor>":         (246,  20, 130),
    "<username>":             (246,  21, 130),
    "</username>":            (246,  22, 130),
    "<ip>":                   (246,  23, 130),
    "</ip>":                  (246,  24, 130),
